    ...
    <section className="mx-auto max-w-4xl px-6 py-20">
      <div className="rounded-3xl border border-border bg-card px-8 py-12 text-center">
        ...
        <TransitionLink
          href="/booking"
          kind="esrog"
          className="hover-wiggle mt-6 inline-block rounded-full bg-primary px-7 py-3 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90"
        >
          Start a booking
        </TransitionLink>
      </div>
